...
public class Mobscout {
    ...
    // Creates a new Block with the id "mobscout:example_block", combining the namespace and path
    public static final RegistryObject<Block> EXAMPLE_BLOCK = BLOCKS.register("example_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    // Creates a new BlockItem with the id "mobscout:example_block", combining the namespace and path
    public static final RegistryObject<Item> EXAMPLE_BLOCK_ITEM = ITEMS.register("example_block", () -> new BlockItem(EXAMPLE_BLOCK.get(), new Item.Properties()));

    // Creates a new food item with the id "mobscout:example_id", nutrition 1 and saturation 2
    ...
    // Creates a creative tab with the id "mobscout:example_tab" for the example item, that is placed after the combat tab
